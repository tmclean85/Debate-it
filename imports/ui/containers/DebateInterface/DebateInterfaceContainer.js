...
import { captureUserVote, modalToggle } from '../../../redux/modules/vote';
...
class DebateInterfaceContainer extends Component {
    ...
    modalToggle(value) {
        this.props.dispatch(modalToggle(value));
    }
            ...
            return (
                (this.props.match.params.userId === Meteor.userId()) ?
                    <DebateInterface
                        ...
                        handleClose={this.modalToggle.bind(this)}
...
function mapStateToProps(state) {
    return {
        ...
        modalOpen: state.vote.modalOpen
    };
}
